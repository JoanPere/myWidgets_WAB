  ...
  function(
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      postCreate: function() {
        ...
        debugger;
        //this.it_urlService.value = this.config.overviewMap.urlService;
      ...
      setConfig: function(config) {
        this.config = config;
        debugger;
        this.it_urlService.setValue(this.config.overviewMap.urlService);
      ...
      getConfig: function() {
        ...
        this.config.overviewMap.urlService = this.it_urlService.value;
